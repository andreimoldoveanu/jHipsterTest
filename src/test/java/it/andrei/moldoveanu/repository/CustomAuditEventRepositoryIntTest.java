package it.andrei.moldoveanu.repository;

import it.andrei.moldoveanu.JHipsterTestApp;
import it.andrei.moldoveanu.config.Constants;
import it.andrei.moldoveanu.config.audit.AuditEventConverter;
import it.andrei.moldoveanu.domain.PersistentAuditEvent;
...
import static it.andrei.moldoveanu.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
