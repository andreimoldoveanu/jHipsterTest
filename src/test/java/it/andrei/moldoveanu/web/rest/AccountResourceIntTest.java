package it.andrei.moldoveanu.web.rest;

import it.andrei.moldoveanu.config.Constants;
import it.andrei.moldoveanu.JHipsterTestApp;
import it.andrei.moldoveanu.domain.Authority;
import it.andrei.moldoveanu.domain.PersistentToken;
import it.andrei.moldoveanu.domain.User;
import it.andrei.moldoveanu.repository.AuthorityRepository;
import it.andrei.moldoveanu.repository.PersistentTokenRepository;
import it.andrei.moldoveanu.repository.UserRepository;
import it.andrei.moldoveanu.security.AuthoritiesConstants;
import it.andrei.moldoveanu.service.MailService;
import it.andrei.moldoveanu.service.dto.UserDTO;
import it.andrei.moldoveanu.web.rest.errors.ExceptionTranslator;
import it.andrei.moldoveanu.web.rest.vm.KeyAndPasswordVM;
import it.andrei.moldoveanu.web.rest.vm.ManagedUserVM;
import it.andrei.moldoveanu.service.UserService;
